...
class LiveDisplayModePickerFragment : SettingsPreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        addPreferencesFromResource(
            com.evervolv.settings.R.xml.live_display_mode_settings
        )
        ...
        if (!manager.config.hasFeature(MODE_OUTDOOR)) {
            ...
            if (autoIdx >= 0) {
                modes[autoIdx].summary = screen.context.resources.getString(
                    com.evervolv.settings.R.string.live_display_outdoor_mode_summary
                )
            }
        }
