...
object TouchscreenGestureConstants {
    ...
    fun getDefaultGestureActions(
        ...
        val defaultActions = context.resources.getIntArray(
            com.evervolv.settings.R.array.config_defaultTouchscreenGestureActions
        )
    ...
    fun buildPreferenceKey(gesture: TouchscreenGesture): String {
