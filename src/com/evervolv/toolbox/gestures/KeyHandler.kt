...
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_CAMERA
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_FLASHLIGHT
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_BROWSER
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_DIALER
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_EMAIL
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_MESSAGES
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_NOTHING
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_PLAY_PAUSE_MUSIC
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_PREVIOUS_TRACK
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_NEXT_TRACK
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_VOLUME_DOWN
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.ACTION_VOLUME_UP
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.UPDATE_EXTRA_ACTION_MAPPING
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.UPDATE_EXTRA_KEYCODE_MAPPING
import com.evervolv.toolbox.gestures.TouchscreenGestureConstants.UPDATE_PREFS_ACTION
...
class KeyHandler(private val context: Context) : DeviceKeyHandler {
    ...
    override fun handleKeyEvent(event: KeyEvent): KeyEvent? {
        ...
        if (action < ACTION_NOTHING || event.action != KeyEvent.ACTION_UP || !isSetupComplete()) {
            ...
            msg.arg1 = action
            gestureWakeLock.acquire(2L * proximityTimeOut)
            if (isProximityWakeEnabled()) {
                eventHandler.sendMessageDelayed(msg, 2L * proximityTimeOut)
    ...
    private fun isProximityWakeEnabled(): Boolean {
        ...
        return EVSettings.System.getInt(
            context.contentResolver,
    ...
    private fun doHapticFeedback() {
        val feedbackEnabled = vibrator.hasVibrator() &&
